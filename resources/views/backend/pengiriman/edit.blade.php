    ...
    <form action="/pengiriman/{{$pengiriman->id}}" method="POST">
      <div class="card-body mt-3">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <input type="text" class="form-control @error('nama_pengirim') is-invalid @enderror" name="nama_pengirim" placeholder="Nama Pengirim" value="{{ $pengiriman->nama_pengirim }}">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <input type="number" class="form-control @error('nohp_pengirim') is-invalid @enderror" name="nohp_pengirim" placeholder="No Handphone" value="{{ $pengiriman->nohp_pengirim }}">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <textarea name="alamat_pengirim" class="form-control @error('alamat_pengirim') is-invalid @enderror" rows="5">{{ $pengiriman->alamat_pengirim }}</textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <input type="text" class="form-control @error('nama_penerima') is-invalid @enderror" name="nama_penerima" placeholder="Nama Penerima" value="{{ $pengiriman->nama_penerima }}">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <input type="number" class="form-control @error('nohp_penerima') is-invalid @enderror" name="nohp_penerima" placeholder="No Handphone" value="{{ $pengiriman->nohp_penerima }}">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <textarea name="alamat_penerima" class="form-control @error('alamat_penerima') is-invalid @enderror" rows="5">{{ $pengiriman->alamat_penerima }}</textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <input type="text" class="form-control @error('no_resi') is-invalid @enderror" name="no_resi" placeholder="No Resi" value="{{ $pengiriman->no_resi }}" readonly>
            ...
            <div class="input-group">
              <select class="form-control select2bs4" name="kantorcabang_id">
                ...
                @foreach ($kantorcabang as $item)
                  @if ($item->id === $pengiriman->kantorcabang_id)
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <select class="form-control" name="jenis_barang" id="jenis_barang" onchange="total()">
                ...
                @if ($pengiriman->jenis_barang == 'Dokumen')
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <select class="form-control" name="layanan" id="layanan" onchange="total()">
                ...
                @if ($pengiriman->layanan == 'Reguler')
                    <option value="Reguler" selected>Reguler</option>
                    <option value="Sameday">Sameday</option>
                @else
                    <option value="Reguler">Reguler</option>
                    <option value="Sameday" selected>Sameday</option>
                @endif
              </select>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <input type="number" class="form-control @error('berat') is-invalid @enderror" name="berat" placeholder="Berat" id="berat" onchange="total()" value="{{ $pengiriman->berat }}">
          ...
          <div class="col-sm-9 col-lg-10">
            <div class="input-group">
              <select class="form-control" name="status">
                ...
                @if ($pengiriman->status == 'Input')
                  <option value="Input" selected>Input</option>
                  <option value="Keluar">Keluar</option>
                  <option value="Dibawa">Dibawa</option>
                  <option value="Diterima">Diterima</option>
                @elseif ($pengiriman->status == 'Keluar')
                  <option value="Input">Input</option>
                  <option value="Keluar" selected>Keluar</option>
                  <option value="Dibawa">Dibawa</option>
                  <option value="Diterima">Diterima</option>
                @elseif ($pengiriman->status == 'Dibawa')
                  <option value="Input">Input</option>
                  <option value="Keluar">Keluar</option>
                  <option value="Dibawa" selected>Dibawa</option>
                  <option value="Diterima">Diterima</option>
                @else
                  <option value="Input">Input</option>
                  <option value="Keluar">Keluar</option>
